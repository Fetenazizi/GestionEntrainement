...
class EntrainementsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('nom_entrainement', TextType::class, [
                'label' => 'Nom de l\'entrainement', // Étiquette pour ce champ
            ...
            ->add('duree', TextType::class, [
                ...
                'constraints' => [
                   ...
                   new LessThanOrEqual([
                        'value' => 60,
                        'message' => 'La durée ne peut pas dépasser 60',
                    ]),
                ],
            ])
